...
To pad the images on the black image: <br/>
  load the left and right images <br/>
  resize the left and right images <br/>
  create a black image on which the right and left will be padded <br/>
  determine the pixel positions on the black image where the upper left corners of the left and right iages will be mapped <br/>
  paste the two images onto the black image <br/>
