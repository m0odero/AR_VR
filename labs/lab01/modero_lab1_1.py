...
# values from image 1
c1 = 623; d1 = 46;  c2 = 623; d2 = 596
c3 = 239; d3 = 360; c4 = 239; d4 = 230
'''
# values from image 2
c1 = 413; d1 = 209; c2 = 439; d2 = 428
c3 = 185; d3 = 428; c4 = 314; d4 = 209
'''
# The four points of the processed image are the corners 
# of a rectangle
...
# values from image 1
a1 = 700; b1 = 20;  a2 = 700; b2 = 560
a3 = 4;   b3 = 560; a4 = 4;   b4 = 20
'''
# values from image 2
a1 = 330; b1 = 200; a2 = 330; b2 = 820
a3 = 180; b3 = 820; a4 = 200; b4 = 180
'''
...
# obtaining the size (rows and columns) of the distorted 
# image
...
# looping through the black image and inserting the correct 
# pixel values
for row in range( 1, rows ):
    for col in range ( 1, cols ):
        ...
        if ( v[2][0] != 0 ):
            a_b = np.array( [ [ int( np.round( v[0][0]/v[2][0] ) ) ], 
            [ int( np.round( v[1][0]/v[2][0] ) ) ] ] )
            
            # check to ensure the pixels obtained from the computation 
            # are within bounds of the  
            if ( 0 < a_b[0][0] and a_b[0][0] < rows and 
                 0 < a_b[1][0] and a_b[1][0] < cols ):
                black_img_array[ row, col ] = distorted_im_arr[ int( a_b[0][0] ), 
                int( a_b[1][0] ) ]                             
